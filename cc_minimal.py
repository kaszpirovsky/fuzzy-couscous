...
def cc(ma=1,price=0,fast=100,slow=200,USD=1,EUR=1,GBP=1,CHF=1,JPY=1,AUD=1,CAD=1,NZD=1,calcUSD=1,calcEUR=1,calcGBP=1,calcCHF=1,calcJPY=1,calcAUD=1,calcCAD=1,calcNZD=1,bar=0):
